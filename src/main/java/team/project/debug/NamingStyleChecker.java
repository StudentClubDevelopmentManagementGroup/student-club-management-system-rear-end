...
@Component
public class NamingStyleChecker {
    Logger logger = LoggerFactory.getLogger(this.getClass());

    @Value("team.project") private String rootPackage;
    @Value("_template")    private String templatePackageName;
    @Value("Tmpl")         private String tmplPrefix;
    ...
    private void checkClass(Class<?> clazz) {
        ...
        if ( ! packageName.startsWith(rootPackage) || packageName.contains(templatePackageName)) {
            return;
        }
