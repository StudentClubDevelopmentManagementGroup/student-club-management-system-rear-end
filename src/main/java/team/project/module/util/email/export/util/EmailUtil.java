...
public class EmailUtil {
    ...
    /**
     * <p>  将 html 模板中的占位符替换成对应的参数，并给替换后的 html 包裹一段简单的 css 样式
     ...
     * */
    public static String formatAndWrapCSS(String htmlTmpl, Object ...args) {
        return "<div class='e'><style>" + CSS + "</style>" + String.format(htmlTmpl, args) + "</div>";
    }
