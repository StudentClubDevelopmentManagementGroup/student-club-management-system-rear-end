...
public class AnnService {
    ...
    public PageVO<AnnDetailVO> searchActivity(PagingQueryReq pageReq, AnnSearchReq searchReq) {
        Page<AnnDO> page = new Page<>(pageReq.getPageNum(), pageReq.getPageSize(), true);
        ...
        List<AnnDetailVO> result = new ArrayList<>();
        for (AnnDO annDO : announcementMapper.searchActivity(page, searchQO)) {
            result.add( modelConverter.toAnnDetailVO(annDO, null, annDO.getSummary()) );
        }
    ...
    public PageVO<AnnDetailVO> searchOther(PagingQueryReq pageReq, AnnSearchReq searchReq) {
        Page<AnnDO> page = new Page<>(pageReq.getPageNum(), pageReq.getPageSize(), true);
        ...
        List<AnnDetailVO> result = new ArrayList<>();
        for (AnnDO annDO : announcementMapper.searchOther(page, searchQO)) {
            result.add( modelConverter.toAnnDetailVO(annDO, null, annDO.getSummary()) );
        }
