 ...
 * <p>
 * <h3> 占位模板参数识别规则
 * <p>  如果以 #{ } 来作占位参数的分界符，则 #{ } 所包裹的字符串，截取前后空格后就是参数的名称
 * <p>  模板："Hello, #{ name }! Today is #{ day }."
 * <br> 参数：["name", "day"]
 * <p>  参数名要求起始和结束不含空白字符，但不必遵守标识符的起名规则，可以包含特殊字符
 * <p>  模板："4-2=#{ @ }, 1+1=#{ ## } "
 * <br> 参数：["@", "##"]
 * <p>  如果 #{ } 内部还有 #{ }，则将内部的 #{ } 识别为参数，外部的识别为文本
 * <br> 如果 #{ } 内部为空，则忽略这个占位符
 * <p>  模板："#{ #{} 1! 5!  }"
 * <br> 参数：[]
 * <br> 解释："#{ #{} 1! 5!  }" 内部还有 #{ }，所以外部的 #{ } 识别为文本，而内部的 #{ } 为空，则忽略这个占位符
 * <br> 所以整个模板只有一个文本，即 "#{  1! 5!  }"
 * */
public class TextTemplate {
     ...
     * <p>  以键值对形式提供参数，键是占位参数的名称，值是要替换成的内容
    ...
    /**
     * <p>  渲染模板，根据提供的参数映射替换模板中的占位参数，并返回生成的文本
     * <p>  以列表形式提供参数，参数列表中的元素会依次替换模板中的占位参数
